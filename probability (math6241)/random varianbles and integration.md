...
If $a^m \downarrow a$, then we have $A_{m+1}:=\{X_i \leq a^{m+1}_i \} \subseteq \{X_i \leq a^m_i\}$ and $\lim_{i\to\infty} A_i = A := \{X_i \leq a_i\}$. By **Lemma**, we have 
$$\mathbb{P}(\bigcap_{i=1}^\infty A_i) = \lim_{i\to\infty}{P}(A_i)$$
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2NjU5MzA4ODgsLTI1NzY1NTE4Nl19
-->