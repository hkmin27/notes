...
We need to show that for any $A_i \in \rho(\mathcal{P})$. Note that taking $A_i := A_i \setminus \bigcup_{j=1}^{i-1} A_i$, we have $\lambda_i$'s are disjoint.
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTk5OTMwMTEwLC0xNDMwMTE3NDU0LDE3Mz
