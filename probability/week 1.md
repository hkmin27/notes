...
**Proof.** Let $\rho(\mathcal{P})$ be the smallest $\lambda$-system which contains $\mathcal{P}$ so that $\rho \mathcal{L} 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwNDUzMjY2MzksLTE0MzAxMTc0NTQsMT
