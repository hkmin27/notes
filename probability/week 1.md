...
This allows to define the field/$\sigma$-field generated by a set: if $\mathcal{S}$ is any collection of subsets of $\Omega$ then the intersection of all fields containing $\mathcal{S}$ is called a field 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2NzgwNTE4NDksMjE1Mzc5ODYxLC0yMD
M4MDY3ODQzLC0xMDA2MzI4ODM1LC0yMDg4NzQ2NjEyXX0=
-->