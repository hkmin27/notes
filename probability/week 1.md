...
**e.g.** Let $\mathcal{R}^n$ be the $\sigma$-field in $\mathbb{R}^n$ generated by hyperrectangles $\prod_{i=1}^n (a_i, b_i]$: Borel $\sigma$-field of subsets of $\mathbb{R}^n$.
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0Mzc1NDk5ODYsMjE1Mzc5ODYxLC0yMD
