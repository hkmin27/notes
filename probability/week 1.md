...
$A'_i = A_i \setminus \bigcup_{j=1}^{i-1} A_j = A_i \cap \bigcap_{j=1}^{i-1} A_i^c$. So it only remains to check that $\rho(\
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4MzMxMjc1MjgsLTE0MzAxMTc0NTQsMT
