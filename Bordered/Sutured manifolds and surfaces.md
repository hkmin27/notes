...
**Definition 3.** Let $\mathcal{F} = (F,\Lambda)$ be a sutured surface. A *dividing set* $\Gamma$ for $\mathcal{F}$ is a finite collection of 

---

<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQ2NjM5NzU3NCwxNjIzNzUyMTJdfQ==
-->