...
$$\sum_{i+j=n+1} \sum_{l=1}^{n-j+1} \mu_i(a_1 \otimes \cdots \otimes a_{l-1} \otimes \mu_j(a_l \otimes \cdots \otimes a_{l+j-1})\otimes a_{l+j} \otimes  \cdots \otimes a_n)$$
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTY3MjYwMDU1NSw2MzQ4MDIyMTMsLTIwMj
