...
$$(S,T,\phi) \cdot (U,V,\psi) = \begin{cases} (S,V,\psi \circ \phi) \quad &\text{if } T=U \text{and } \text{inv}(\phi)+\text{inv}(\psi)=\text{inv}(\psi\circ\phi) \\0 &\text{else}\end{cases} $$


---
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTgwMjA4MDk4MCwzNDU0NDg5NDJdfQ==
-->