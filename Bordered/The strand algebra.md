...
$$(S,T,\phi) \cdot (U,V,\psi) = \begin{cases} (S,V,\psi \circ \phi) \quad &\text{if T=U and inv($\phi$)+inv($\psi$)=inv(\psi\circ\phi)}\\0 &else \end{cases} $$


---
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTExMjQxMjIwNjksMzQ1NDQ4OTQyXX0=
-->