...
The proof of **Corollary 2.5.** doesn't work since $\mathcal{L}$ is not a $\lambda$-system. (consider a complement of R$\square$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5MjcwMTY2MjQsLTEzMjU5NjMyNzUsMT
